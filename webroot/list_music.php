...
$result = [
    [
        ...
        "tag_name"       => ["鼻歌","ルンルン","サビ"],
        "url"            => "https://storage.googleapis.com/vac-storage-1/test1.aac",
    ...
    [
        ...
        "url"            => "https://storage.googleapis.com/vac-storage-1/test2.aac",
        "user_name"      => "無名の鼻歌師",
        "download_count" => 3
    ],
    [
        ...
        "url"            => "https://storage.googleapis.com/vac-storage-1/test3.aac",
        "user_name"      => "歴史に残るハミングクリエイター",
        "download_count" => 8
    ],
    [
        ...
        "url"            => "https://storage.googleapis.com/vac-storage-1/test4.aac",
    ...
    [
        ...
        "url"            => "https://storage.googleapis.com/vac-storage-1/test5.aac",
        "user_name"      => "無名の鼻歌師",
        "download_count" => 10
    ],
    [
        ...
        "tag_name"       => ["鼻歌","おしゃれカフェ"],
        "url"            => "https://storage.googleapis.com/vac-storage-1/test6.aac",
        "user_name"      => "歴史に残るハミングクリエイター",
        "download_count" => 8
    ]
];
